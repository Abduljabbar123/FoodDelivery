...
import { AddNewAddress, AddNewCard, AddPromo, Address, Call, CancelOrder, CancelOrderPaymentMethods, Categories, ChangeEmail, ChangePassword, ChangePIN, Chat, CheckoutOrders, CheckoutOrdersAddress, CheckoutOrdersCompleted, CreateNewPassword, CreateNewPIN, CustomerService, DiscountFoods, DriverDetails, EditProfile, Ereceipt, Favourite, FillYourProfile, Fingerprint, FoodDetails, FoodDetailsAbout, FoodDetailsAddItem, FoodDetailsOffers, FoodReviews, ForgotPasswordEmail, ForgotPasswordMethods, ForgotPasswordPhoneNumber, GiveTipForDriver, Inbox, Login, MyCart, Notifications, Onboarding1, Onboarding2, Onboarding3, Onboarding4, Orders, OtpVerification, PaymentMethods, Profile, RateTheDriver, RateTheStore, RecommendedFoods, Search, SearchingDriver, SettingsHelpCenter, SettingsInviteFriends, SettingsLanguage, SettingsNotifications, SettingsPayment, SettingsPrivacyPolicy, SettingsSecurity, Signup, TopupConfirmPIN, TopupEwalletAmount, TopupMethods, TrackDriver, TransactionHistory, VideoCall, VoiceCall, Wallet, Welcome, WhatsYourMood } from '../screens';
