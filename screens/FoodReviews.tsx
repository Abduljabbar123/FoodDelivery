...
const FoodReviews = () => {
        ...
        <TouchableWithoutFeedback
          ...
          <View style={[styles.modalContainer]}>
            <View style={[styles.modalSubContainer, {
              ...
              />
              <TextInput
                placeholder="This pet food is so great 🔥"
  ...
  */
  const renderContent = () => {
    ...
    const filteredReviews = selectedRating === "All" ? productReviews : productReviews.filter(review => review.avgRating === selectedRating);
    return (
      <ScrollView
